...
import {addHouse, getAllTypes} from "../../../service/house_service";
...
export function CreateHouse() {
    ...
    const add = async (house) => {
        const res = {...house, typeRent: JSON.parse(house.typeRent)};
        const newHouse = await addHouse(res);
